...
import com.kiocg.java.GroupMessage.Realize.Link;
    ...
    public void onCommandsPublic(final GroupMessageEvent event) {
        ...
        switch (msg.toLowerCase()) {
            ...
            case ("client"):
                ...
                break;
            case ("poster"):
                e.getGroup().sendMessage("服务器宣传帖：https://www.mcbbs.net/thread-1173769-1-1.html" +
                        "\n记得去给个好评哟~");
                break;
            case ("github"):
