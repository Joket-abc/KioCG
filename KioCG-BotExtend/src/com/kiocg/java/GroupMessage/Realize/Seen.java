package com.kiocg.java.GroupMessage.Realize;
...
public class Seen {
    public void seen(final GroupMessageEvent e, final String msg) {
        ...
        stringBuilder.append(Objects.requireNonNull(ChatColor.stripColor(gmUtils.getPlayerDisplayName(offlinePlayer))).replaceAll("&#.{6}", ""))
        ...
        stringBuilder.append("\n死亡次数：").append(offlinePlayer.getStatistic(Statistic.DEATHS)).append("次   距上次死亡：")
                .append(gmUtils.ticksToDHMS(offlinePlayer.getStatistic(Statistic.TIME_SINCE_DEATH)));
